    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-surface px-4 py-12">
      <div className="w-full max-w-5xl flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <Link href="/learn" className="text-sm text-on-surface-variant hover:text-on-surface transition-colors">
            {"← Back"}
          </Link>
          <h1 className="font-display text-xl font-bold text-on-surface">Learn Mode</h1>
          <Link href="/learn" className="text-sm text-on-surface-variant hover:text-on-surface transition-colors">
            Change
          </Link>
        </div>
        ...
        <div className="card flex flex-col items-center gap-1">
          ...
          <span className="font-display text-[6rem] leading-none font-bold text-on-surface select-none">
            {target}
          </span>
        </div>

        {/* Side-by-side webcam + reference */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="flex flex-col gap-3">
            <p className="text-sm font-semibold text-on-surface-variant">Your camera</p>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-sm font-semibold text-on-surface-variant">Reference sign</p>
            <div className="relative w-full overflow-hidden rounded-[2rem] ghost-border bg-surface-container-lowest ambient-shadow aspect-video">
              <Image
            ...
            <p className="text-sm text-on-surface-variant">{signReference.hint}</p>
          </div>
        </div>
